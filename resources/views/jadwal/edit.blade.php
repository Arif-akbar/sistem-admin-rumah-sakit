...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="metric-label">Ubah jadwal praktik</p>
        </div>
    ...
    <div class="card" style="max-width: 700px;">
        <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}" class="form">
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="hari" name="hari" class="form-control @error('hari') is-invalid @enderror">
                            @foreach ($days as $day)
                                <option value="{{ $day }}"
                                    {{ old('hari', $jadwal->hari) == $day ? 'selected' : '' }}>{{ $day }}</option>
                            @endforeach
                        </select>
                        @error('hari')
                            <span class="form-error">{{ $message }}</span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="kuota_pasien" name="kuota_pasien" min="1" max="100"
                        value="{{ old('kuota_pasien', $jadwal->kuota_pasien) }}"
